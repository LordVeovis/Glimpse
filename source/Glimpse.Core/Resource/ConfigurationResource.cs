...
namespace Glimpse.Core.Resource
{
    ...
    public class ConfigurationResource : IPrivilegedResource, IKey
    {
        ...
        public IResourceResult Execute(IResourceContext context, IGlimpseConfiguration configuration)
        {
            ...
            content.Append("<script type=\"text/javascript\">/*<[CDATA[*/var toggleClass = function(name) { toggleItems(document.getElementsByClassName(name)); }, toggleItems = function(e) { for(var i = 0; i < e.length; i++) { toggleItem(e[i]); } }, toggleItem = function(e) { if(e.style.display == 'none') { e.style.display = ''; } else { e.style.display = 'none'; } };/*]]>*/</script>");
